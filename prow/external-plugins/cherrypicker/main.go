...
func gatherOptions() options {
	...
	fs.BoolVar(&o.issueOnFailure, "create-issue-on-failure", false, "Create a GitHub issue and assign it to the requestor if a cherrypick fails.")
...
func main() {
	...
	server := &Server{
		...
		allowAll:        o.allowAll,
		issueOnFailure:  o.issueOnFailure,
